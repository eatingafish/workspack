...
public abstract class WDActivity extends AppCompatActivity {
    ...
    public LoginInfo LOGIN_USER;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        //查询登录用户，方便每个页面使用
        LoginInfoDao LoginInfoDao = DaoMaster.newDevSession(this, com.example.dao.LoginInfoDao.TABLENAME).getLoginInfoDao();
        List<LoginInfo> userInfos = LoginInfoDao.queryBuilder().where(com.example.dao.LoginInfoDao.Properties.Status.eq(1)).list();
